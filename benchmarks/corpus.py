...
def generate_query_set(corpus: list[MemoryEntry], num_queries: int = 50, seed: int = 42) -> list[dict[str, object]]:
    ...
    for _ in range(num_queries):
        ...
        expected: list[str] = [e.id for e in corpus if all(w.lower() in e.content.lower() for w in query_words)]
...
def create_golden_set(output_path: Path) -> None:
    ...
    _entries_data: list[tuple[str, str, list[str], float, list[tuple[str, bool]]]] = [
        ...
        (
            "golden-001",
            "Pydantic v2 requires model_config = ConfigDict(strict=True) for type enforcement",
            ["python", "pydantic"],
            0.9,
        ...
        (
            "golden-002",
            "FastAPI dependency injection uses Depends() for request-scoped services",
            ["python", "fastapi"],
            0.85,
        ...
        (
            "golden-003",
            "Python asyncio event loop must not be nested without nest_asyncio",
            ["python", "asyncio"],
            0.8,
        ...
        (
            "golden-004",
            "mypy --strict catches implicit Any and missing return types",
            ["python", "mypy"],
            0.75,
        ...
        (
            "golden-005",
            "pytest fixtures with autouse=True run for every test in scope",
            ["python", "pytest"],
            0.8,
        ...
        (
            "golden-006",
            "Python typing.Protocol enables structural subtyping without inheritance",
            ["python", "typing"],
            0.7,
        ...
        (
            "golden-007",
            "Pydantic Field(alias='name') requires populate_by_name=True in model_config",
            ["python", "pydantic"],
            0.85,
        ...
        (
            "golden-008",
            "React useEffect cleanup function runs before component unmount",
            ["javascript", "react"],
            0.8,
        ...
        (
            "golden-009",
            "TypeScript discriminated unions need a literal type tag field",
        ...
        (
            "golden-010",
            "Node.js streams handle backpressure via highWaterMark setting",
            ["javascript", "node"],
            0.7,
        ...
        (
            "golden-011",
            "Vitest uses vi.fn() for mocking functions in unit tests",
            ["javascript", "vitest"],
            0.75,
        ...
        (
            "golden-012",
            "Zod schema validation integrates with React Hook Form via resolver",
            ["javascript", "zod"],
            0.8,
        ...
        (
            "golden-013",
            "Next.js App Router uses server components by default for performance",
            ["javascript", "nextjs"],
            0.85,
        ...
        (
            "golden-014",
            "TypeScript satisfies operator validates type without widening",
            ["javascript", "typescript"],
            0.7,
        ...
        (
            "golden-016",
            "PostgreSQL EXPLAIN ANALYZE shows actual execution time per plan node",
            ["database", "postgres"],
            0.85,
        ...
        (
            "golden-017",
            "Redis SET with NX and EX flags implements distributed locks",
            ["database", "redis"],
            0.8,
        ...
        (
            "golden-018",
            "Database migration scripts must be idempotent for safe re-runs",
            ["database", "migration"],
            0.9,
        ...
        (
            "golden-019",
            "Composite indexes in SQL follow leftmost prefix rule for queries",
            ["database", "indexing"],
            0.85,
        ...
        (
            "golden-020",
            "SQL query plans degrade when statistics are stale after bulk loads",
            ["database", "query"],
            0.75,
        ...
        (
            "golden-021",
            "Docker multi-stage builds reduce final image size by separating build deps",
            ["devops", "docker"],
            0.85,
        ...
        (
            "golden-022",
            "CI/CD pipeline caching of node_modules speeds up JavaScript builds",
            ["devops", "ci-cd"],
            0.8,
        ...
        (
            "golden-023",
            "Kubernetes liveness probes restart pods that fail health checks",
            ["devops", "kubernetes"],
            0.9,
        ...
        (
            "golden-024",
            "Prometheus metrics collection requires instrumentation at application level",
            ["devops", "monitoring"],
            0.75,
        ...
        (
            "golden-025",
            "Blue-green deployment eliminates downtime by switching traffic atomically",
            ["devops", "deployment"],
            0.85,
        ...
        (
            "golden-027",
            "JWT tokens should use short expiry with refresh token rotation",
            ["security", "jwt"],
            0.9,
        ...
        (
            "golden-028",
            "bcrypt with cost factor 12 provides adequate password hashing security",
            ["security", "encryption"],
            0.85,
        ...
        (
            "golden-029",
            "RBAC policies should deny by default and grant explicit permissions",
            ["security", "rbac"],
            0.9,
        ...
        (
            "golden-030",
            "OAuth2 PKCE flow prevents authorization code interception attacks",
            ["security", "auth"],
            0.85,
        ...
        (
            "golden-031",
            "CORS preflight OPTIONS requests must include Access-Control-Allow-Methods",
            ["security", "cors"],
            0.8,
        ...
        (
            "golden-032",
            "XSS prevention requires output encoding at every insertion point",
            ["security", "xss"],
            0.9,
        ...
        (
            "golden-033",
            "Unit tests should not depend on external services or file system state",
            ["testing", "unit"],
            0.85,
        ...
        (
            "golden-034",
            "Integration tests need database fixtures reset between test runs",
            ["testing", "integration"],
            0.8,
        ...
        (
            "golden-035",
            "Code coverage below 80% indicates untested critical paths",
            ["testing", "coverage"],
            0.75,
        ...
        (
            "golden-036",
            "Mocking should target the module where the name is looked up, not defined",
            ["testing", "mocking"],
            0.9,
        ...
        (
            "golden-037",
            "Test fixtures should be minimal and create only what the test requires",
            ["testing", "fixtures"],
            0.8,
        ...
        (
            "golden-038",
            "TDD red-green-refactor cycle catches regressions before they ship",
            ["testing", "tdd"],
            0.85,
        ...
        (
            "golden-039",
            "Microservices need distributed tracing to debug cross-service failures",
        ...
        (
            "golden-040",
            "Monolith-first approach reduces complexity until scale demands splitting",
        ...
        (
            "golden-041",
            "Event-driven architecture decouples producers from consumers via message bus",
        ...
        (
            "golden-042",
            "CQRS separates read models from write models for scalability",
            ["architecture", "cqrs"],
            0.85,
        ...
        (
            "golden-043",
            "Domain-driven design bounded contexts prevent model pollution across teams",
            ["architecture", "ddd"],
            0.9,
        ...
        (
            "golden-044",
            "Clean architecture dependency rule: outer layers depend on inner layers only",
            ["architecture", "clean"],
            0.85,
        ...
        (
            "golden-045",
            "Embedding models must normalize vectors for cosine similarity to work correctly",
            ["ai-ml", "embeddings"],
            0.9,
        ...
        (
            "golden-046",
            "LLM temperature 0 produces deterministic outputs for reproducible pipelines",
            ["ai-ml", "llm"],
            0.85,
        ...
        (
            "golden-047",
            "RAG retrieval quality depends on chunk size and overlap parameters",
            ["ai-ml", "rag"],
            0.9,
            [
                ("rag chunk size overlap", True),
                ("database pagination", False),
                ("retrieval augmented generation", True),
            ],
        ),
        (
            "golden-048",
            "Fine-tuning on fewer than 100 examples risks catastrophic forgetting",
            ["ai-ml", "fine-tuning"],
            0.8,
        ...
        (
            "golden-049",
            "System prompts should front-load critical instructions for attention",
            ["ai-ml", "prompting"],
            0.85,
            [
                ("system prompt instructions", True),
                ("user input parsing", False),
                ("prompt engineering attention", True),
            ],
        ),
        (
            "golden-050",
            "Agent tool-use loops need max-iteration guards to prevent infinite chains",
            ["ai-ml", "agents"],
            0.9,
    ...
    for eid, content, tags, importance, query_pairs in _entries_data:
        queries_list: list[dict[str, object]] = [{"query": q, "relevant": r} for q, r in query_pairs]
...
def create_dedup_set(output_path: Path) -> None:
    ...
    pairs: list[dict[str, object]] = [
        # --- True duplicates (paraphrases) ---
        {
            "id": "dedup-001",
            "entry_a": {
                "content": "Pydantic v2 uses ConfigDict instead of class Config",
                "tags": ["python", "pydantic"],
            },
            "entry_b": {
                "content": "In Pydantic version 2, ConfigDict replaces the old class Config pattern",
                "tags": ["python", "pydantic"],
            },
        ...
        },
        {
            "id": "dedup-003",
            "entry_a": {
                "content": "FastAPI dependency injection uses Depends for services",
                "tags": ["python", "fastapi"],
            },
            "entry_b": {
                "content": "In FastAPI, service dependencies are injected via the Depends function",
                "tags": ["python", "fastapi"],
            },
            "expected_duplicate": True,
        },
        {
            "id": "dedup-004",
            "entry_a": {
                "content": "React useState hook triggers re-render on state change",
                "tags": ["javascript", "react"],
            },
            "entry_b": {
                "content": "Kubernetes pod affinity rules control scheduling placement",
        ...
        },
        {
            "id": "dedup-005",
            "entry_a": {
                "content": "pytest fixtures provide reusable test setup and teardown",
                "tags": ["testing", "pytest"],
            },
            "entry_b": {
                "content": "In pytest, fixtures handle test setup and cleanup in a reusable way",
                "tags": ["testing", "pytest"],
            },
            "expected_duplicate": True,
        },
        {
            "id": "dedup-006",
            "entry_a": {
                "content": "JWT tokens should have short expiry times for security",
                "tags": ["security", "jwt"],
            },
            "entry_b": {
                "content": "Redis pub/sub enables real-time messaging between services",
                "tags": ["database", "redis"],
            },
            "expected_duplicate": False,
        },
        {
            ...
            "entry_b": {
                "content": "Generics in TypeScript allow writing components that are both reusable and type-safe",
                "tags": ["javascript", "typescript"],
            },
            "expected_duplicate": True,
        },
        {
            "id": "dedup-008",
            "entry_a": {
                "content": "Alembic migrations must be run in order for schema consistency",
        ...
        },
        {
            ...
            "entry_b": {
                "content": "Python asyncio.gather executes coroutines in parallel concurrently",
                "tags": ["python", "asyncio"],
            },
            "expected_duplicate": True,
        },
        {
            "id": "dedup-010",
            "entry_a": {
                "content": "Terraform plan shows infrastructure changes before apply",
                "tags": ["devops", "terraform"],
            },
            "entry_b": {
                "content": "Next.js getServerSideProps runs on every request for SSR",
        ...
        },
        {
            ...
            "entry_b": {
                "content": "The OPTIONS method is used for CORS preflight checks",
                "tags": ["security", "cors"],
            },
            "expected_duplicate": True,
        },
        {
            "id": "dedup-012",
            "entry_a": {
                "content": "Code coverage tools measure which lines are executed during tests",
                "tags": ["testing", "coverage"],
            },
            "entry_b": {
                "content": "Embedding vectors must be normalized for cosine similarity",
        ...
        },
        {
            "id": "dedup-013",
            "entry_a": {
                "content": "Microservices communicate via API gateways or message queues",
                "tags": ["architecture", "microservices"],
            },
            "entry_b": {
                "content": "In microservice architectures, services talk through API gateways or message queues",
                "tags": ["architecture", "microservices"],
            },
            "expected_duplicate": True,
        },
        {
            "id": "dedup-014",
            "entry_a": {
                "content": "LLM fine-tuning requires curated high-quality training data",
        ...
        },
        {
            "id": "dedup-015",
            "entry_a": {
                "content": "mypy --strict catches missing type annotations in Python code",
                "tags": ["python", "mypy"],
            },
            "entry_b": {
                "content": "Running mypy in strict mode detects missing type annotations",
                "tags": ["python", "mypy"],
            },
            "expected_duplicate": True,
        },
        {
            "id": "dedup-016",
            "entry_a": {
                "content": "Docker volumes persist data across container restarts",
                "tags": ["devops", "docker"],
            },
            "entry_b": {
                "content": "Integration tests verify component interactions end-to-end",
        ...
        },
        {
            "id": "dedup-017",
            "entry_a": {
                "content": "RAG systems split documents into chunks for vector retrieval",
                "tags": ["ai-ml", "rag"],
            },
            "entry_b": {
                "content": "Retrieval-augmented generation chunks documents for vector-based search",
                "tags": ["ai-ml", "rag"],
            },
            "expected_duplicate": True,
        },
        {
            "id": "dedup-018",
            "entry_a": {
                "content": "RBAC policies should follow least-privilege principle",
                "tags": ["security", "rbac"],
            },
            "entry_b": {
                "content": "Node.js process.env reads environment variables at runtime",
        ...
        },
        {
            "id": "dedup-019",
            "entry_a": {
                "content": "Event-driven systems use message brokers for async communication",
                "tags": ["architecture", "event-driven"],
            },
            "entry_b": {
                "content": "Async communication in event-driven architectures relies on message brokers",
                "tags": ["architecture", "event-driven"],
            },
            "expected_duplicate": True,
        },
        {
            "id": "dedup-020",
            "entry_a": {
                "content": "SQLite FTS5 provides full-text search with ranking functions",
                "tags": ["database", "sqlite"],
            },
            "entry_b": {
                "content": "Zod schemas validate runtime data in TypeScript applications",
                "tags": ["javascript", "zod"],
            },
            "expected_duplicate": False,
        },
        {
            "id": "dedup-021",
            "entry_a": {
                "content": "Clean architecture puts business logic in the domain layer",
                "tags": ["architecture", "clean"],
            },
            "entry_b": {
                "content": "In clean architecture, the domain layer contains all business logic",
                "tags": ["architecture", "clean"],
            },
            "expected_duplicate": True,
        },
        {
            "id": "dedup-022",
            "entry_a": {
                "content": "Kubernetes namespaces isolate resources within a cluster",
                "tags": ["devops", "kubernetes"],
            },
            "entry_b": {
                "content": "bcrypt is recommended for password hashing over SHA-256",
        ...
        },
        {
            "id": "dedup-023",
            "entry_a": {
                "content": "TDD requires writing failing tests before implementation code",
                "tags": ["testing", "tdd"],
            },
            "entry_b": {
                "content": "Test-driven development means writing tests that fail before writing the code",
                "tags": ["testing", "tdd"],
            },
            "expected_duplicate": True,
        },
        {
            "id": "dedup-024",
            "entry_a": {
                "content": "CI/CD pipelines should run linting before expensive test suites",
                "tags": ["devops", "ci-cd"],
            },
            "entry_b": {
                "content": "DDD aggregate roots enforce consistency boundaries",
        ...
        },
        {
            "id": "dedup-025",
            "entry_a": {
                "content": "LLM prompting benefits from few-shot examples in the context",
                "tags": ["ai-ml", "prompting"],
            },
            "entry_b": {
                "content": "Including few-shot examples in LLM prompts improves output quality",
                "tags": ["ai-ml", "prompting"],
            },
            "expected_duplicate": True,
        },
        {
            ...
            "entry_b": {
                "content": "React Server Components reduce client-side JavaScript bundle size",
                "tags": ["javascript", "react"],
            },
            "expected_duplicate": False,
        },
        {
            "id": "dedup-027",
            "entry_a": {
                "content": "Vitest supports concurrent test execution for faster feedback",
                "tags": ["javascript", "vitest"],
            },
            "entry_b": {
                "content": "Concurrent test running in Vitest speeds up the test feedback loop",
                "tags": ["javascript", "vitest"],
            },
            "expected_duplicate": True,
        },
        {
            "id": "dedup-028",
            "entry_a": {
                "content": "Monitoring dashboards need alerting thresholds for SLO violations",
                "tags": ["devops", "monitoring"],
            },
            "entry_b": {
                "content": "CQRS enables independent scaling of read and write workloads",
        ...
        },
        {
            "id": "dedup-029",
            "entry_a": {
                "content": "Agent tool-calling requires structured output parsing for reliability",
                "tags": ["ai-ml", "agents"],
            },
            "entry_b": {
                "content": "Reliable agent tool use depends on structured output parsing",
                "tags": ["ai-ml", "agents"],
            },
            "expected_duplicate": True,
        },
        {
            "id": "dedup-030",
            "entry_a": {
                "content": "PostgreSQL indexes should be analyzed after bulk data loads",
                "tags": ["database", "postgres"],
            },
            "entry_b": {
                "content": "OAuth2 authorization code flow is preferred over implicit flow",
                "tags": ["security", "auth"],
            },
            "expected_duplicate": False,
        },
